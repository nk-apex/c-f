...
export default {
  name: 'antisticker',
  alias: ['nosticker'],
  description: 'Toggle anti-sticker auto-moderation for the group',
  category: 'group',
  ownerOnly: false,
  ...
  async execute(sock, msg, args, PREFIX, extra) {
    ...
    if (action === 'on') {
      data[jid]['antisticker'] = true;
      saveAutomod(data);
      return sock.sendMessage(jid, { text: '┌─⧭ ANTI-STICKER ⧭─┐\n│ Enabled successfully.\n│ Status: ON\n└─⧭━━━━━━━━━━━━━━━━━━━━━━━━━━⧭─┘' }, { quoted: msg });
    } else if (action === 'off') {
      data[jid]['antisticker'] = false;
      saveAutomod(data);
      return sock.sendMessage(jid, { text: '┌─⧭ ANTI-STICKER ⧭─┐\n│ Disabled successfully.\n│ Status: OFF\n└─⧭━━━━━━━━━━━━━━━━━━━━━━━━━━⧭─┘' }, { quoted: msg });
    } else {
      const current = data[jid]['antisticker'] ? 'ON' : 'OFF';
