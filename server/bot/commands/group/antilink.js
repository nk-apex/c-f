...
export default {
  name: 'antilink',
  alias: ['nolink'],
  description: 'Toggle anti-link auto-moderation for the group',
  category: 'group',
  ownerOnly: false,
  ...
  async execute(sock, msg, args, PREFIX, extra) {
    ...
    if (action === 'on') {
      data[jid]['antilink'] = true;
      saveAutomod(data);
      return sock.sendMessage(jid, { text: '┌─⧭ ANTI-LINK ⧭─┐\n│ Enabled successfully.\n│ Status: ON\n└─⧭━━━━━━━━━━━━━━━━━━━━━━━━━━⧭─┘' }, { quoted: msg });
    } else if (action === 'off') {
      data[jid]['antilink'] = false;
      saveAutomod(data);
      return sock.sendMessage(jid, { text: '┌─⧭ ANTI-LINK ⧭─┐\n│ Disabled successfully.\n│ Status: OFF\n└─⧭━━━━━━━━━━━━━━━━━━━━━━━━━━⧭─┘' }, { quoted: msg });
    } else {
      const current = data[jid]['antilink'] ? 'ON' : 'OFF';
