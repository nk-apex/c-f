...
export default {
  name: 'antipromote',
  alias: ['nopromote'],
  description: 'Toggle anti-promote auto-moderation for the group',
  category: 'group',
  ownerOnly: false,
  ...
  async execute(sock, msg, args, PREFIX, extra) {
    ...
    if (action === 'on') {
      data[jid]['antipromote'] = true;
      saveAutomod(data);
      return sock.sendMessage(jid, { text: '┌─⧭ ANTI-PROMOTE ⧭─┐\n│ Enabled successfully.\n│ Status: ON\n└─⧭━━━━━━━━━━━━━━━━━━━━━━━━━━⧭─┘' }, { quoted: msg });
    } else if (action === 'off') {
      data[jid]['antipromote'] = false;
      saveAutomod(data);
      return sock.sendMessage(jid, { text: '┌─⧭ ANTI-PROMOTE ⧭─┐\n│ Disabled successfully.\n│ Status: OFF\n└─⧭━━━━━━━━━━━━━━━━━━━━━━━━━━⧭─┘' }, { quoted: msg });
    } else {
      const current = data[jid]['antipromote'] ? 'ON' : 'OFF';
