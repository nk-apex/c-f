...
export default {
  name: 'antigrouplink',
  alias: ['nogrouplink'],
  description: 'Toggle anti-group-link auto-moderation for the group',
  category: 'group',
  ownerOnly: false,
  ...
  async execute(sock, msg, args, PREFIX, extra) {
    ...
    if (action === 'on') {
      data[jid]['antigrouplink'] = true;
      saveAutomod(data);
      return sock.sendMessage(jid, { text: '┌─⧭ ANTI-GROUP-LINK ⧭─┐\n│ Enabled successfully.\n│ Status: ON\n└─⧭━━━━━━━━━━━━━━━━━━━━━━━━━━⧭─┘' }, { quoted: msg });
    } else if (action === 'off') {
      data[jid]['antigrouplink'] = false;
      saveAutomod(data);
      return sock.sendMessage(jid, { text: '┌─⧭ ANTI-GROUP-LINK ⧭─┐\n│ Disabled successfully.\n│ Status: OFF\n└─⧭━━━━━━━━━━━━━━━━━━━━━━━━━━⧭─┘' }, { quoted: msg });
    } else {
      const current = data[jid]['antigrouplink'] ? 'ON' : 'OFF';
